...
app1 = Blueprint("app1", __name__, url_prefix="/app1", template_folder='templates')
...
def chart():
    ...
    return render_template('app/chart.html', title="Global Business Sentiment", charts=charts, charts_comments=charts_comments)